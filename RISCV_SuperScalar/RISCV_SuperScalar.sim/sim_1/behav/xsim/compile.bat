...
REM
REM Generated by Vivado on Mon Feb 09 16:13:04 +0100 2026
...
echo "xvhdl --incr --relax -prj RISCV_pipeline_tb_vhdl.prj"
call xvhdl  --incr --relax -prj RISCV_pipeline_tb_vhdl.prj -log xvhdl.log
