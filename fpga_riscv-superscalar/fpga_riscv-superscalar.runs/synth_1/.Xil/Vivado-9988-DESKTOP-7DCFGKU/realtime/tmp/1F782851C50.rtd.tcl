...
set genomeRtd $env(RT_TMP)/1F782851C50.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Memory_2_ports__GB1}]"
...
set genomeName [subst -nocommands -novariables {Memory_2_ports__GB1}]
