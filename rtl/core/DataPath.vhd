...
architecture structural of DataPath is
    ...
    signal btb_predict_taken_IF, btb_predict_taken_IF_mux : std_logic_vector(1 downto 0);
    ...
    signal CSR_MEM : CSR_array; --> (0 to 1) of std_logic_vector(11 downto 0)
    ...
    signal CSR_WB : CSR_array; --> (0 to 1) of std_logic_vector(11 downto 0)
...
begin
    ...
    BRANCH_PREDICTOR: entity work.BTB_superscalar
        ...
        port map(
            ...
            inst_format_0 => uins_ID(0).format,
            inst_format_1 => uins_ID(1).format,
    ...
    gen_duplicate : for i in 0 to ISSUE_WIDTH-1 generate
        ...
        id_i: entity work.Stage_ID(behavioral)
            port map (
                ...
                branch_taken_in     => btb_predict_taken_IF_mux(i),
        ...
        mem_i: entity work.Stage_MEM(behavioral)
            port map (
                ...
                rd_in            => rd_EX(i),
                rd_out           => rd_MEM(i),
                CSR_in           => imm_data_EX(i)(11 downto 0), -- imm_data_EX have the CSR address for CSR instructions
                CSR_out          => CSR_MEM(i),
                uins_in          => uins_EX(i),
                uins_out         => uins_MEM(i)
            );
